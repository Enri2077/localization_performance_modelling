...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', dest='cache_file_path',
                        help='Folder containing the result the runs. Defaults to ~/ds/performance_modelling/output/test_localization/run_data_cache.pkl',
                        type=str,
                        default="~/ds/performance_modelling/output/test_localization/",
                        required=False)

    parser.add_argument('-o', dest='output_folder',
                        help='Folder in which the results will be placed. Defaults to ~/ds/performance_modelling/plots/test_localization/',
                        type=str,
                        default="~/ds/performance_modelling/plots/test_localization/",
                        required=False)
